...
public:
    ArgumentManager() { }
    ArgumentManager(int argc, char const *argv[], char delimiter=';');
    ArgumentManager(string rawArguments, char delimiter=';');
    void parse(int argc, char const *argv[], char delimiter=';');
...
void ArgumentManager::parse(int argc, char const *argv[], char delimiter) {
    if (argc > 1) {
...
ArgumentManager::ArgumentManager(int argc, char const *argv[], char delimiter) {
